...
<!-- Mirrored from html.themefax.com/regfood/sign_up.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Sep 2023 08:34:38 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
            ...
            <div class="row justify-content-center wow fadeInUp" data-wow-duration="1s">
                <div class="col-xl-5 col-sm-10 col-md-8 col-lg-6">
                    <div class="tf__login_area">
                        ...
                        <p class="create_account">Have an aceount ? <a href="sign_in.php">login</a></p>
                    </div>
                </div>
            </div>
        </div>

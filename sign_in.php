...
<!-- Mirrored from html.themefax.com/regfood/sign_in.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Sep 2023 08:34:38 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
            ...
            <div class="row justify-content-center wow fadeInUp" data-wow-duration="1s">
                <div class="col-xl-5 col-sm-10 col-md-8 col-lg-6">
                    <div class="tf__login_area">
                        ...
                        <form name="admin" method="post" action="action/login.php">
                            <div class="row">
                                <div class="col-xl-12">
